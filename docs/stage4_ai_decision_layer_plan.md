...
- **P2 current gate state:** BTC has prior actual graduation evidence; ETH prompt repair done but not runtime-validated; ETH watch reappearance gate not ready; backend HOLD; operator runbook created; no 30m now; no 60m; Stage 4.19 blocked; next runtime only after ETH watch conditions reappear.
