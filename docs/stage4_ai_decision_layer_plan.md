...
- **4.18p1c:** Clean 30m shadow sample + BTC follow-up gate — runtime-gated; **PASS** (6/6 ticks, 23 effective; shadow Cerebras×6; comparable 1→5; uncomparable=truncation×1 only; shadow_valid_watch=5 vs actual=0; skill comparison valid but **P2 not auto-started**; actual BTC valid_watch=0 so follow-up N/A; flags reset); **Stage 4.19 remains blocked**; **60m not run**.
