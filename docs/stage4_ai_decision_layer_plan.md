...
- **4.18p1-r1:** 30m BTC dual-provider shadow sample — runtime-gated; **PASS** (6/6 ticks, 20 effective, shadow JSONL×6, exclusions verified, flags reset); shadow valid_watch=0 vs actual BTC valid_watch=1; **no P2 routing**; **Stage 4.19 remains blocked**; **60m not run**.
