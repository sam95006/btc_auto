...
- **4.18g:** 30m LLM MAE schema regression — read-only soak to validate 418F prompt; **PARTIAL** (technical PASS, MAE caps still violated, 0 graduations, deploy drift — 418F files not in container); **Stage 4.19 not ready**.
