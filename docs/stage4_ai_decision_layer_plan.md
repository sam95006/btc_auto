...
- **P2 current gate state:** BTC has prior actual graduation evidence; ETH prompt repair done but not runtime-validated; ETH watch reappearance gate not ready; no 30m now; no 60m; Stage 4.19 blocked.
