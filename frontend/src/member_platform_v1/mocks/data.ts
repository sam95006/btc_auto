...
export const MOCK_PLANS: PlanDto[] = [
  {
    ...
    features: ["市場總覽", "Top 20 排行", "今日重點", "基礎風險提醒", "觀察清單最多 10"],
  },
  {
    id: "advanced",
    name: "進階版",
    ...
    dailyValue: "完整排行、進出場觀察、進階風險提醒與 30 天歷史",
    features: ["Top 50 排行", "為什麼值得看", "進出場觀察", "進階風險提醒", "觀察清單最多 50", "30 天歷史"],
  },
  {
    id: "professional",
    name: "專業版",
    tagline: "完整證據與即時提醒",
    priceLabel: "NT$ 1,599 / 月",
    audience: "積極交易與策略執行者",
    dailyValue: "即時風險、完整證據、衍生品與流動性、180 天回溯",
    highlighted: true,
    features: ["Top 100 排行", "完整市場證據", "即時風險提醒", "觀察清單無上限", "180 天歷史", "衍生品／流動性"],
  },
  {
    id: "enterprise",
    name: "企業版",
    ...
    dailyValue: "專業版全部能力 + 權限、儀表板與 API 整合諮詢",
    features: ["專業版全部功能", "團隊權限與席位", "自訂儀表板", "API / Bridge 諮詢", "專屬客戶經理"],
  },
];
