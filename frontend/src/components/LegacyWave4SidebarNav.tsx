...
/** Stable Zeabur Wave 4 IA — unchanged when member_surface_v18_2_1 is off. */
...
export function LegacyWave4MobileBottomNav() {
...
export function LegacyWave4SidebarNav() {
  const [expertOpen, setExpertOpen] = useState(false);
  return (
    <>
      <nav
        className="sidebar-nav sidebar-nav-compact nx-nav-p2 nx-nav-p3 nx-nav-p4 nx-nav-p65 nx-nav-w4"
        aria-label="Primary"
      >
        <div className="sidebar-brand-block">
          <div className="sidebar-product">NEXUS</div>
          <div className="sidebar-product-sub muted">Live Market Intelligence</div>
        </div>
