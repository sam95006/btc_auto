...
/**
 * NEXUS Member Product V2 — Paid Product Visual + True Market Series (V18.2.18).
        ...
        <AnomalyOutcomeProvider>
          <MarketScannerProvider>
            <div
              ...
              data-member-surface="v18_2_18"
              data-mp2-theme="dark"
              data-testid="nexus-member-product-v2"
              data-build-marker="PUBLIC_V18_2_18_PAID_PRODUCT_VISUAL_HEAD"
            >
