        ...
        <AnomalyOutcomeProvider>
          ...
          <MarketScannerProvider>
            ...
            <div
              ...
              className="nx10-shell nx-actual-panel-v1821"
            ...
            >
              ...
              <div className="nx10-body">
                ...
                <div className="nx10-main-column">



                  <main className="nx10-main" id="main-content" tabIndex={-1}>



                    <div className="nx10-grid">
