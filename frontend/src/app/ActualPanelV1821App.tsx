...
/**
 * V18.2.8 member product shell — command bar + expandable rail + 12-col main.
 * No top legal wall; density toggles not in chrome.
 */
      ...
      <MarketAnomalyProvider>
        <AnomalyOutcomeProvider>
          <MarketScannerProvider>
            <div
              className="v1828-shell nx-actual-panel-v1821"
              data-member-surface="v18_2_1"
              data-product-gen="v18_2_8"
            >
