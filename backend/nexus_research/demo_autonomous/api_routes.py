    ...
    def nexus_autonomous_position():
        try:
            ...
            return jsonify({
                ...
                "currentOrder": st.get("currentOrder"),
                "openOrders": st.get("openOrders") or [],
                "protectionOrders": st.get("protectionOrders") or [],
                "protectionGroups": st.get("protectionGroups") or [],
                "protectionVerdict": st.get("protectionVerdict"),
