...
DEFAULT_CONTENT: dict[str, dict[str, Any]] = {
    ...
    "products": {"title": "產品 / Products", "intro": "One intelligence core, delivered through separate products.",
                 "items": [
                     {"key": "personal", "title": "Personal Market Intelligence",
                      "summary": "Individual member SaaS.", "to": "/personal"},
                     {"key": "enterprise", "title": "Enterprise Intelligence Workspace",
                      "summary": "Team / organization product.", "to": "/enterprise"},
                 ]},
    ...
    "security": {"title": "安全與信任 / Security & Trust",
                 "points": [
                     ...
                     {"title": "Strict product boundaries", "body": "Private trading is never exposed through the company website."},
                     {"title": "Least-privilege administration", "body": "Owner/admin access is backend-enforced with audit logging."},
                 ]},
