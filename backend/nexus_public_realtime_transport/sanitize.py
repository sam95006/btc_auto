"""Payload sanitization for public realtime events."""
from __future__ import annotations

from typing import Any

from backend.nexus_public_realtime_transport.constants import FORBIDDEN_PAYLOAD_KEYS


class ForbiddenPayloadKeyError(ValueError):
    """Raised when a banned key appears in a public stream payload."""
