...
from config.llm_config import DEFAULT_MAX_COMPLETION_TOKENS, DEFAULT_TIMEOUT_SECONDS, GROQ_CHAT_COMPLETIONS_URL, MODEL_FALLBACKS

from .structured_output_parser import parse_json_content


class GroqLLMClient:
    def __init__(self, api_key_env: str, endpoint: str = GROQ_CHAT_COMPLETIONS_URL):
