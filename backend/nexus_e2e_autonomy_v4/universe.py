"""Multi-symbol / multi-regime fixture universe for V15-K end-to-end autonomy campaign V4.

System correctness only — no edge, no profitability, no OOS.
100+ fixture symbols registered with lot-compliant InstrumentSpec for simulation.
"""
...
# Core tradable defaults + synthetic fixture universes → 100+ symbols.
_FIXTURE_BASES: tuple[str, ...] = (
    ...
    "SNX", "STX", "THETA", "XLM", "EOS", "XTZ", "KAVA", "RUNE", "ZIL", "ONE",
    "CELO", "KSM", "MINA", "ROSE", "CFX", "AR", "GMX", "SSV", "PENDLE", "WLD",
    "ORDI", "SATS", "MEME", "BONK", "FLOKI", "NOT", "STRK", "PYTH", "JTO", "W",
    "ENA", "ETHFI", "BOME", "OMNI", "REZ", "BB", "IO", "ZK", "ZRO", "LISTA",
    "BANANA", "CATI", "EIGEN", "GOAT", "ACT", "PNUT", "MOVE", "ME", "VANA",
    "VIRTUAL", "PENGU", "USUAL", "BIO", "ANIME", "TRUMP", "MELANIA", "IP",
    "KAITO", "BERA", "LAYER", "SHELL", "GPS", "EPIC", "BAN", "OM", "NXPC",
)
    ...
    *,
    ...
    for i in range(count):
        ...
        if i > 0 and i % 37 == 0:
            ...
            fault_tag = "capture_degradation"

        out.append(
            {
                "candidate_id": f"v15k_cand_{seed}_{i:06d}",
                "market_context_id": f"v15k_mctx_{seed}_{symbol}_{regime}",
