"""Payload sanitization for Public Live Data Adapter."""
from __future__ import annotations

from typing import Any

from backend.nexus_public_live_data.constants import FORBIDDEN_PAYLOAD_KEYS


class ForbiddenPayloadKeyError(ValueError):
    """Raised when a banned key appears in a live-data payload."""
