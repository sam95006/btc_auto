"""Secret / forbidden-key scan for Lesson Prevention V2 artifacts."""
...
from backend.nexus_lesson_prevention_v2.constants import FORBIDDEN_LOG_KEYS, SCHEMA_SECRET_SCAN
...
def scan_payload(payload: Any) -> dict[str, Any]:
    ...
    for key in FORBIDDEN_LOG_KEYS:
        # Match JSON keys only — not incidental substrings in labels.
