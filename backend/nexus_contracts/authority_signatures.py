...
DOMAIN_SIGNATURES: dict[str, tuple[dict[str, Any], ...]] = {
    ...
    "checkpoint": (
        {"kind": "class", "name": "CanonicalCheckpointStore"},
        {"kind": "assign", "name": "ENVELOPE_SCHEMA"},
        {"kind": "assign", "name": "CANONICAL_CHECKPOINT_ENVELOPE_COUNT"},
        {"kind": "func", "name": "build_envelope"},
        {"kind": "func", "name": "checkpoint_path"},
        {"kind": "func", "name": "recover_from_checkpoint"},
        {"kind": "class", "name": "CheckpointStore"},
        {"kind": "class", "name": "DecisionCheckpointStore"},
