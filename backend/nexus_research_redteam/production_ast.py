"""V14-L production AST mutation wrapper.
...
Surviving Critical mutations block V14 readiness.
"""
...
def run_v14_production_ast_campaign(root: Path | None = None) -> dict[str, Any]:
    ...
    return {
        "campaign": "v14_production_ast_mutation",
