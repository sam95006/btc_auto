#!/usr/bin/env python3
"""PUB18-A Live Funnel gate — three passes + leak / execution-control attestation."""
...
from backend.nexus_pub18_live_funnel.constants import (  # noqa: E402
    BASE_COMMIT,
    BRANCH,
    FAIL_RECOMMENDATION,
    LANE,
...
from backend.nexus_pub18_live_funnel.hard_bans import run_three_passes  # noqa: E402
...
def main() -> int:
    ...
    payload = {
        ...
        "execution_control_count": result.get("execution_control_count", 1),
