...
FORBIDDEN_VALIDATION = "6a82a79aa21454a2cf6b0015"
...
def main() -> int:
    ...
    if preset in {FORBIDDEN_MEMBER_PREVIEW, FORBIDDEN_STAGE3, FORBIDDEN_VALIDATION, FORBIDDEN_VALIDATION_OBSOLETE}:
