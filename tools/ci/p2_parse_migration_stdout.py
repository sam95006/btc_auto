#!/usr/bin/env python3
"""Emit a diagnostic-only allowlist from untrusted P2 migration stdout."""
...
def parse_migration_stdout(raw: str) -> dict[str, Any]:
    ...
    return {
        ...
        "migration_runner_verdict": bool(payload.get("P2_MIGRATION_0007_APPLIED_PASS")),
        ...
        "p2_research_lessons_present": post.get("p2_research_lessons_present"),
        "source_evidence_hash_unique": post.get("source_evidence_hash_unique"),
        "policy_truth_support_constraint": post.get("policy_truth_support_constraint"),
    }
