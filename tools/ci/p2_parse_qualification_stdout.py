...
def parse_qualification_stdout(raw: str) -> dict[str, Any]:
    ...
    return {
        ...
        "PROCESS_B_PREWRITE_LESSON_FOUND": payload.get("PROCESS_B_PREWRITE_LESSON_FOUND"),
        "PROCESS_B_PREWRITE_MEMORY_HIT": payload.get("PROCESS_B_PREWRITE_MEMORY_HIT"),
        "PROCESS_B_WRITES_BEFORE_MEMORY_CHECK": payload.get("PROCESS_B_WRITES_BEFORE_MEMORY_CHECK"),
        "DUPLICATE_LESSON_COUNT": payload.get("DUPLICATE_LESSON_COUNT"),
        "DUPLICATE_LESSON_IDEMPOTENCY_PASS": payload.get("DUPLICATE_LESSON_IDEMPOTENCY_PASS"),
