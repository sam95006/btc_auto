...
BASE_ALLOWLIST = [
    ...
    "tools/research/analyze_stage4_provider_yield.py",
    "tools/research/analyze_stage4_prompt_budget.py",
    "tools/research/check_cerebras_auth_minimal.py",
    "tools/research/check_groq_auth_minimal.py",
    ...
    "tools/research/stage4_parse_error_metrics.py",
    ...
    "tools/research/stage4_provider_stability_review.py",
    "tools/research/stage4_shadow_quality_summary.py",
    "tools/research/stage4_multi_session_review.py",
