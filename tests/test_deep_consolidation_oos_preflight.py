...
def test_recommendation_terminal_oos_state_in_sot():
    ...
    assert sot.get("recommendation") in {
        ...
        "NEXUS_H5_WALK_FORWARD_VALIDATED_NEW_OOS_REQUIRED",
        "NEXUS_H5_RESEARCH_FAILED_NO_DEMO",
        "NEXUS_H5_RESEARCH_INSUFFICIENT_SAMPLE",
        "NEXUS_H5_DATA_OR_IMPLEMENTATION_INVALID",
        "NEXUS_GOAL_ALIGNMENT_V1_COMPLETE_READY_FOR_BROAD_RESEARCH",
        "NEXUS_REAL_AI_PROVIDER_CONFIGURATION_INCOMPLETE",
        "NEXUS_REAL_AI_PROVIDER_SMOKE_FAILED",
        "NEXUS_REAL_AI_LEARNING_LOOP_INTEGRATION_FAILED",
        "NEXUS_REAL_AI_LEARNING_LOOP_DATA_INVALID",
        "NEXUS_REAL_AI_LEARNING_LOOP_VERIFIED_READY_FOR_STRATEGY_ENGINE",
        "NEXUS_STRATEGY_ENGINE_V1_READY_FOR_FORMAL_QUALIFICATION_SELECTION",
        "NEXUS_STRATEGY_ENGINE_V1_NO_PROMISING_MECHANISM",
        "NEXUS_STRATEGY_ENGINE_V1_INSUFFICIENT_RESEARCH_COVERAGE",
        "NEXUS_REFLECTION_EVIDENCE_QUALITY_INSUFFICIENT",
        "NEXUS_STRATEGY_ENGINE_DATA_OR_IMPLEMENTATION_INVALID",
        "NEXUS_HISTORICAL_COVERAGE_INSUFFICIENT",
        "NEXUS_REAL_LEARNING_LOOP_INTEGRATION_FAILED",
        "NEXUS_GOAL_ALIGNMENT_DATA_OR_IMPLEMENTATION_INVALID",
        ...
        "NEXUS_STRATEGY_ENGINE_V11_VALID_DISCOVERY_CANDIDATES_FOUND",
        "NEXUS_STRATEGY_ENGINE_V11_NO_PROMISING_AFTER_DISTINCT_EXECUTION",
        "NEXUS_STRATEGY_ENGINE_V11_REFLECTION_QUALITY_INSUFFICIENT",
        "NEXUS_STRATEGY_ENGINE_V11_DATA_OR_IMPLEMENTATION_INVALID",
        "NEXUS_STRATEGY_ENGINE_V12_DISCOVERY_CANDIDATES_FOUND",
        "NEXUS_STRATEGY_ENGINE_V12_NO_PROMISING_AFTER_BROAD_COVERAGE",
        "NEXUS_STRATEGY_ENGINE_V12_RESEARCH_COVERAGE_INSUFFICIENT",
        "NEXUS_STRICT_COMPONENT_CONFORMANCE_FAILED",
        "NEXUS_REAL_REFLECTION_REQUALIFICATION_FAILED",
        "NEXUS_STRATEGY_ENGINE_V12_DATA_OR_IMPLEMENTATION_INVALID",
        "NEXUS_EDGE_DISCOVERY_CANDIDATES_READY_FOR_FORMAL_SELECTION",
        "NEXUS_H11_RARE_SIGNAL_REQUIRES_MORE_HISTORY",
        "NEXUS_CURRENT_DATA_FAMILIES_NO_SUPPORTED_RAW_EDGE",
        "NEXUS_EDGE_DISCOVERY_DATA_DEPTH_INSUFFICIENT",
        "NEXUS_BLIND_REFLECTION_CALIBRATION_FAILED",
        "NEXUS_EDGE_DISCOVERY_DATA_OR_IMPLEMENTATION_INVALID",
    }
