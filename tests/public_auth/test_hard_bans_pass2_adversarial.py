"""PUB-H Pass 2 adversarial hard-ban probes."""
...
from backend.nexus_public_auth.pass_runner import run_two_passes
...
def test_private_admin_token_rejected_by_session_service():
    ...
    # Craft a token with a different secret claiming private issuer path.
