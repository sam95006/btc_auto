...
# When enabled, leverage follows config/leverage_config CONFIDENCE_LEVERAGE_TABLE (3–100x by score).
USE_CONFIDENCE_LEVERAGE_TABLE = _env_bool("NEXUS_USE_CONFIDENCE_LEVERAGE_TABLE", True)
# When enabled, margin scales with the same confidence bands (0.45x–1.5x base + deployable pool).
USE_CONFIDENCE_MARGIN_TABLE = _env_bool("NEXUS_USE_CONFIDENCE_MARGIN_TABLE", True)

BASE_MARGIN_RADAR = _env_float("NEXUS_CONFIDENCE_BASE_MARGIN_RADAR", 80.0)
BASE_MARGIN_CORE = _env_float("NEXUS_CONFIDENCE_BASE_MARGIN_CORE", 100.0)

ABSOLUTE_MAX_LEVERAGE = _env_float("NEXUS_ABSOLUTE_MAX_LEVERAGE", 100.0)
