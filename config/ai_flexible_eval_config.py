...
AI_FLEX_STALE_EXIT_HOURS = _env_float("NEXUS_AI_FLEX_STALE_EXIT_HOURS", 3.0)
AI_FLEX_STALE_MIN_PROFIT_USD = _env_float("NEXUS_AI_FLEX_STALE_MIN_PROFIT_USD", 4.0)
AI_FLEX_STALE_FLAT_EXIT_HOURS = _env_float("NEXUS_AI_FLEX_STALE_FLAT_EXIT_HOURS", 6.0)
