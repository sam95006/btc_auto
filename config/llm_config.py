...
def task_provider_defaults():
    return {
        ...
        "flex_trade_eval": os.getenv("NEXUS_LLM_PROVIDER_FLEX_TRADE", "groq_primary"),
        "flex_exit_eval": os.getenv("NEXUS_LLM_PROVIDER_FLEX_EXIT", "groq_primary"),
...
def task_model_defaults():
    return {
        ...
        "flex_trade_eval": os.getenv("NEXUS_LLM_MODEL_FLEX_TRADE", "llama-3.3-70b-versatile"),
        "flex_exit_eval": os.getenv("NEXUS_LLM_MODEL_FLEX_EXIT", "llama-3.3-70b-versatile"),
