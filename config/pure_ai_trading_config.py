...
PURE_AI_DYNAMIC_SIZING = _env_bool("NEXUS_PURE_AI_DYNAMIC_SIZING", False)
PURE_AI_DYNAMIC_LEVERAGE_MIN = _env_float("NEXUS_PURE_AI_DYNAMIC_LEVERAGE_MIN", 20.0)
PURE_AI_DYNAMIC_LEVERAGE_MAX = _env_float("NEXUS_PURE_AI_DYNAMIC_LEVERAGE_MAX", 100.0)
PURE_AI_DYNAMIC_MAX_MARGIN_USD = _env_float("NEXUS_PURE_AI_DYNAMIC_MAX_MARGIN_USD", 500.0)
PURE_AI_DYNAMIC_MAX_MARGIN_PCT = _env_float("NEXUS_PURE_AI_DYNAMIC_MAX_MARGIN_PCT", 0.12)
