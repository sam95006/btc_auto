...
RECOVERY_MAX_LEVERAGE = _env_float("NEXUS_RECOVERY_MAX_LEVERAGE", 50.0)
...
RECOVERY_POSITION_MULTIPLIER = _env_float("NEXUS_RECOVERY_POSITION_MULTIPLIER", 1.0)

GROWTH_MIN_QUALITY = _env_float("NEXUS_GROWTH_MIN_QUALITY", 0.66)
GROWTH_MAX_LEVERAGE = _env_float("NEXUS_GROWTH_MAX_LEVERAGE", 100.0)
GROWTH_MIN_APPROVAL = _env_float("NEXUS_GROWTH_MIN_APPROVAL", 0.58)
GROWTH_POSITION_BOOST = _env_float("NEXUS_GROWTH_POSITION_BOOST", 1.35)
GROWTH_MIN_WIN_RATE = _env_float("NEXUS_GROWTH_MIN_WIN_RATE", 0.42)

FLOOR_GUARD_MAX_LEVERAGE = _env_float("NEXUS_FLOOR_GUARD_MAX_LEVERAGE", 50.0)
FLOOR_GUARD_MIN_QUALITY = _env_float("NEXUS_FLOOR_GUARD_MIN_QUALITY", 0.74)

# Bold testnet: effective floor below live CAPITAL_FLOOR so ~3k accounts stay in GROWTH mode.
BOLD_TESTNET_CAPITAL_FLOOR = _env_float("NEXUS_BOLD_TESTNET_CAPITAL_FLOOR", 2500.0)
BOLD_DAILY_DEFENSE_MIN_POSITION_MULT = _env_float("NEXUS_BOLD_DAILY_DEFENSE_MIN_POSITION_MULT", 0.90)
